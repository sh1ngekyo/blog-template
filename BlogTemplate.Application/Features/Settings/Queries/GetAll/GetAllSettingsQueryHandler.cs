...
{
    public class GetAllSettingsQueryHandler : IRequestHandler<GetAllSettingsQuery, Result<List<SettingsDto>>>
    {
        ...
        {
            var settings = await _context.Settings!.ProjectTo<SettingsDto>(_mapper.ConfigurationProvider)!.ToListAsync();
